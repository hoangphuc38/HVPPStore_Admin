...
export const UserNameLoginIcon = ({ width, height, className, color = '#2A2A86' }) => (
...
export const PasswordLoginIcon = ({ width, height, className, color = '#2A2A86' }) => (
    <svg className={className}
        fill={color}
        height={height}
        width={width}
